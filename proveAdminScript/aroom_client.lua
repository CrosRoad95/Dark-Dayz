...
addEventHandler ( "onClientColShapeHit", cuboid, function()
...
addEventHandler ( "onClientColShapeLeave", cuboid, function()

    if getElementData(localPlayer, "aroom_status") then
