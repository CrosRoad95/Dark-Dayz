...
markerNaDach = createMarker(TeleportNaDach[1],TeleportNaDach[2],TeleportNaDach[3],"cylinder",1.5,200,200,0,170)
...
markerZDachu = createMarker(TeleportZDachu[1],TeleportZDachu[2],TeleportZDachu[3],"cylinder",1.5,200,200,0,170)
...
markerNaDach = createMarker(TeleportDoBudynku[1],TeleportDoBudynku[2],TeleportDoBudynku[3],"cylinder",1.5,200,200,0,170)
addEventHandler("onClientMarkerHit",markerNaDach,wejscieNaDach)
...
markerZDachu = createMarker(TeleportZBudynku[1],TeleportZBudynku[2],TeleportZBudynku[3],"cylinder",1.5,200,200,0,170)
addEventHandler("onClientMarkerHit",markerZDachu,zejscieZDachu)
...
for i=0,17 do
	markerWGore[i] = createMarker(startposA[1],startposA[2],startposA[3]+i*5,"cylinder",1.5,200,200,0,170)
	addEventHandler("onClientMarkerHit",markerWGore[i],teleportujWGore)
end

for i=0,17 do
	markerWDol[i] = createMarker(startposB[1],startposB[2],startposB[3]+i*snap,"cylinder",1.5,200,200,0,170)
