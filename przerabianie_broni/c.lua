...
local uslugi = {
	{"Weapon parts","Możesz wytworzyć: ","Bronie"},
...
addEventHandler("onClientRender",root,function()
	...
	dxDrawRectangle(sx * 0.32,sy * 0.32,sx*0.2,sy*0.2,tocolor(0,0,0,interpolacja))
	...
	for i,v in pairs(uslugi) do
		...
		v[3] = "Wymagane: "..v[3]
		if clickGrid == i then
			dxAddGridRow(0.32,0.32,0.2,0.2,i,tocolor(191,191,191,interpolacja > 50 and 50 or interpolacja),interpolacja * 1.4,{naglowek = v[1],glowny = v[2], wymagane = v[3]})
		elseif checkGrid == i then
			dxAddGridRow(0.32,0.32,0.2,0.2,i,tocolor(131,131,131,interpolacja > 50 and 50 or interpolacja),interpolacja * 1.4,{naglowek = v[1],glowny = v[2], wymagane = v[3]})
		else
			dxAddGridRow(0.32,0.32,0.2,0.2,i,tocolor(101,101,101,interpolacja > 50 and 50 or interpolacja),interpolacja * 1.4,{naglowek = v[1],glowny = v[2], wymagane = v[3]})
		end
	end
end)
...
local dane_to_func = {
	[1] = function()
		...
		if bronie >= 1 then
			triggerServerEvent("giveSomething",resourceRoot,"Weapon parts",1)
		end
	end,
}
