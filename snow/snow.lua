...
SnowControl = {
	snow1 = dxCreateTexture ( "images/Snow01.png" ),
	snow2 = dxCreateTexture ( "images/Snow02.png" ),
	snow3 = dxCreateTexture ( "images/Snow03.png" )
}
...
addEventHandler ( "onClientResourceStart", resourceRoot,
	function ( )
		SnowControl.create ( )
		removeEventHandler ( "onClientPreRender", root, SnowControl.draw, false )
	end
, false )
